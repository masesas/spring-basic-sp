...
public class CryptoConverter implements AttributeConverter<String, String> {
    ...
    /**
     * Nilai tanpa penanda dikembalikan apa adanya. Ini yang membuat baris lama yang
     * masih berupa teks biasa tetap terbaca selama masa transisi, sebelum runner
     * migrasi sempat mengenkripsinya.
     */
    @Override
    ...
    public static boolean sudahTerenkripsi(String nilai) {
        return nilai != null && nilai.startsWith(PENANDA);
    }
}
